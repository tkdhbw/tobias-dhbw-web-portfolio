        ...
        >
            <div class="bg-transparent text-white max-w-4xl mx-auto py-8 px-4 sm:px-6 lg:px-8 space-y-6">
                ...
                <ol>
                    ...
                    <li><span className='text-accent'>Lokaler Host (IP-Nummer des lokalen Hosts)</span>Dies ist die IP-Adresse des Geräts, von dem die Verbindung initiiert wird oder auf dem die Anfrage empfangen wird. In Ihrem Beispiel ist <span className='text-accent'>196.8.79.22</span> die IP-Adresse des lokalen Hosts, also beispielsweise des Webservers.</li>
                    ...
                    <li><span className='text-accent'>Fremder Host (IP-Nummer des fremden Hosts):</span>Dies ist die IP-Adresse des Zielgeräts in der Kommunikation, also des Geräts, das die Daten anfordert oder an das die Daten gesendet werden. In diesem Fall ist <span className='text-accent'>132.49.2.3</span> die IP-Adresse des fremden Hosts.</li>
